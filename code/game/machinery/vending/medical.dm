...
/obj/machinery/vending/medical
	...
	products = list(
		/obj/item/chems/glass/bottle/antitoxin = 8,
		/obj/item/chems/glass/bottle/stabilizer = 8,
		/obj/item/chems/glass/bottle/sedatives = 8,
		/obj/item/chems/glass/bottle/bromide = 8,
		/obj/item/chems/syringe/antibiotic = 8,
		/obj/item/chems/syringe = 16,
		/obj/item/scanner/health = 8,
		/obj/item/scanner/breath = 8,
		/obj/item/chems/glass/beaker = 8,
		/obj/item/chems/dropper = 4,
